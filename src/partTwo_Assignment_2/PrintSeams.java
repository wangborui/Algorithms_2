...
public class PrintSeams {
    ...
    public static void main(String[] args) {
        Picture picture = new Picture(new File("C:\\Users\\Borui Wang\\Desktop\\Borui Wang\\Coursera\\Algorithms Part 2\\"
        ...
        StdOut.printf("%s (%d-by-%d image)\n", new File("C:\\Users\\Borui Wang\\Desktop\\Borui Wang\\Coursera\\Algorithms Part 2\\"
                        + "Algorithms Part 2\\assignments\\ProgrammingAssignment2SeamCarvingHelpCenter\\"
                        + "seamCarving-testing\\seamCarving\\diagonals.png"), picture.width(), picture.height());
        StdOut.println();
